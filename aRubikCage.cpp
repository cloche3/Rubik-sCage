...
int put(int ** cage,signed char mycolor,signed char e){//e入力変数（マス数2~9）mycolor入力変数(色数1~6)
...
int ** to_canonical(const int ** cage){
    ...
    for (int e,i = 0; i < 3 ; i++)
    {
        for (e = 0; e < 8; e++) {min_cage[i][e] = cage[i][e];}
    }
    return min_cage;//標準形
}
